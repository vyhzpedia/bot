...
var authFolder = storeSystem.fixFileName(`${Helper.opts._[0] || ''}KonekoSessions`)
...
async function connectionUpdate(update) {
  ...
  if (connection === "open") {
       ...
       const infoMsg = `• ᴋᴏɴᴇᴋᴏ ᴠ𝟿 ʙᴇʀʜᴀsɪ ᴛᴇʀʜᴜʙᴜɴɢ\n• © ʀᴇʏᴢ ʜᴀʏᴀɴᴀsɪ`;
       conn.sendMessage("6282213445634@s.whatsapp.net", {
            text: infoMsg,
